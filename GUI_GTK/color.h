...
// -> [ ] en bleus; ok en verts; le reste en couleur par deffault

//pour afficher du texte en couleur faire:
//	cout << YELLOW << " salut yokoso " << DEFFAULT_COLOR;


//Sinon il faut chercher du c��t�� de la lib ncurses. Si ta console est sur fond clair et que tu compiles avec gcc rajoute �� la compilation l'option -DBG_LIGHT :
